...
casper.test.begin('App Test', 8, function mySuite(test) { 
...
this.echo("Page Element is visible "+flag);
      ...
      // test.assertVisible(".navbar-toggle","The menu should be visible");

 test.assertNotVisible(".myclass-toggle","The element should NOT be visible when width < 620");
            } 
...
this.echo("Page Element is visible "+flag);
  ...
  test.assertVisible(".myclass-toggle","The element should be visible for width > 620");
