...
//test through browsers via selenium
  ...
  //In absence of above selinium server, Local server will be starrted with following options
   

  /*
 localSeleniumStandaloneOpts: {
    jvmArgs: [
      '-Dwebdriver.ie.driver=IEDriverServer_x64_3.150.0/IEDriverServer.exe'
    ]
  },
*/
